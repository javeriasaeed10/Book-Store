              ...
              {localStorage.getItem("id") && (
                <div className=" w-full md:w-auto flex flex-row md:flex-col justify-between md:justify-start items-center  mt-4 md:mt-0  ">
                  {role !== "admin" && (
                    <>
                      <button
                        className="bg-white p-3 rounded lg:rounded-full text-2xl lg:text-3xl text-red-500 font-semibold hover:bg-zinc-200 transition-all duration-300 flex items-center"
                      ...
                      <button
                        className="mt-0 md:mt-8 bg-blue-500 text-white p-3 rounded lg:rounded-full text-2xl  font-semibold flex items-center hover:bg-blue-600 transition-all duration-300"
                        onClick={addToCart}
                      >
                        <FaCartShopping />{" "}
