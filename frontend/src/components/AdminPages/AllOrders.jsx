  ...
  useEffect(() => {
    const fetch = async () => {
      try {
        ...
        console.log("Fetched Order History:", res.data.data); // Debugging log
            ...
            >
              ...
              <div className="w-[40%] md:w-[22%]">
                {items.book ? (
                  ...
                  <span className="text-red-500">Book info missing</span>
                )}
              </div>
              <div className="w-0 md:w-[45%] hidden md:block">
                <h1 className="">
              ...
              <div className="w-[30%] md:w-[16%]">
                <h1 className="font-semibold">
                  ...
                  <div
                    className={`${EditableDiv === i ? "block" : "hidden"} flex mt-4`}
                  >
                    <select
                      name="status"
